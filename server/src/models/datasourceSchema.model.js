...
//user object create
var DsSchema=function(dsschema){
...
DsSchema.sanitizeName = function(name){
  return name.replace(/[^a-zA-Z0-9_]/g, "_");
}
DsSchema.exists = async function (name) { 
...
DsSchema.update = async function (record,id) {
  delete record.force
...
DsSchema.reset = async function(id){
  var status,output
