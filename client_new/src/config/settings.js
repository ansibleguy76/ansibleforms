...
export default {
    ...
    aap:{
        ...
        icon: "fac,ansible",
        actions: [{ name: "test", title: `Test Connection`, icon: "plug" }],
        fields: [
            { key: "use_credentials", label: "Use credentials", type: "checkbox", isAction: true },
            { key: "ignore_certs", label: "Ignore Certs", type: "checkbox", isAction: true },
            { key: "uri", icon: "globe", line: 0, label: "Uri", required: true },
            { key: "username", icon: "user", line: 2, label: "Username", required: true, dependency: "use_credentials" },
            { key: "password", icon: "lock", line: 2, label: "Password", type: "password", required: true, dependency: "use_credentials" },
            { key: "token", icon: "lock", line: 1, label: "Token", type: "password", required: true, dependency: "use_credentials", negateDependency: true },
            { key: "ca_bundle", icon: "certificate", type: "textarea", line: 6, label: "Ca Bundle", required: true, dependency: "ignore_certs", negateDependency: true, placeholder: "-----BEGIN CERTIFICATE-----" },
        ],
    },
    entraId:{
