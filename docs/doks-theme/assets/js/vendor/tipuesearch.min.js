...
{out+='<div class="has-text-primary fw-bold mt-2"><a href="'+found[i].url+'"'+tipue_search_w+'>'+found[i].title+'</a></div>';if(set.debug)
{out+='<div class="tipue_search_content_debug">Score: '+found[i].score+'</div>';}
if(set.showURL)
{var s_u=found[i].url.toLowerCase();if(s_u.indexOf('http://')==0)
{s_u=s_u.slice(7);}
out+='<div class="tipue_search_content_url d-none"><a href="'+found[i].url+'"'+tipue_search_w+'>'+s_u+'</a></div>';}
if(found[i].desc)
...
{var patr=new RegExp('('+d+')','gi');t=t.replace(patr,"<span class=\"fw-bold\">$1</span>");}
...
{t_d+=' ...';}
t_d=t_d.replace(/h0011/g,'span class=\"fw-bold\"');t_d=t_d.replace(/h0012/g,'/span');out+='<div class="tipue_search_content_text">'+t_d+'</div>';}}
l_o++;}
...
{d_o=d;}
if(!f)
{out+='<div class="tipue_search_related_title">'+tipuesearch_string_15+' <span class="fw-bold">'+d_o+'</span></div><div class="tipue_search_related_cols">';}
