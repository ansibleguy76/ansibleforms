    ...
    <div :class="{'mb-3':!isInline,'d-flex align-items-center':isInline}">
      ...
      <div v-if="icon && !['select','datetime','file'].includes(type)">
        ...
        <div class="input-group">
          ...
          <p @dblclick="dblclick" v-else-if="type=='expression' && isHtml" class="form-control" :style="style" v-html="sanitizedModel" :class="cssClass"></p>
      ...
      <div v-else>
        ...
        <p @dblclick="dblclick" v-else-if="type=='expression' && isHtml" class="form-control" :style="style" v-html="sanitizedModel" :class="[cssClass, {'is-invalid': hasError}]"></p>
